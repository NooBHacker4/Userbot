...
USER_BOT_NO_WARN = ("Hello, My Friend My Boss `@certified_youtuber` **Is Quite Busy In His Works Soo Kindly Leave A Message As Soon As possible My Boss Will Reply**")
